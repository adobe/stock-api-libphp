<?php
/**
 * PSR2Stock_Sniffs_NamingConventions_ValidFunctionNameSniff.
 *
 * PHP version 5
 *
 * @category  PHP
...
class ValidFunctionNameSniff extends AbstractScopeSniff
{
    ...
    /**
     * Constructs a PSR2Stock_Sniffs_NamingConventions_ValidFunctionNameSniff.
     */
    ...
    protected function processTokenWithinScope(File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if ($isPublic === false) {
            if ($methodName{0} !== '_') {
                ...
                $phpcsFile->recordMetric($stackPtr, 'Private/Protected method prefixed with underscore', 'no');
                return;
            } else {
                $phpcsFile->recordMetric($stackPtr, 'Private/Protected method prefixed with underscore', 'yes');
            }
        }
